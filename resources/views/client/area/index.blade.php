      ...
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            ...
            <div class="container">
              <h1 class="mt-3" style="color: #272556">Areas management</h1>
              <hr>
       ...
       @endif
                    ...
                    <table class="table table-bordered table-striped fs--1 mb-0">
                      ...
                      <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td class="ACTION">
                              <a data-bs-toggle="modal" data-bs-target="#editArea{{ $area->id }}" class="btn btn-secondary mr-2" title="Update">
              ...
              <div class="modal fade" id="editArea{{$area->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
              style="display: none;" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Edit Area</h5><button class="btn p-1"
                      ...
                      <form action="/restaurant/area/update/{id}" method="post">
                          ...
                          <div class="modal-body">
                              <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                  <input name="name"  value ="{{$area->name}}"  class="form-control" id="exampleFormControlInput1"
                                      type="text"   >
                                  @error('name')
                              ...
                              <input type="hidden" value="{{ $area->id}}" name="idarea" >
