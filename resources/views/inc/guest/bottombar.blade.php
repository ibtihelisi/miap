    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer-col first">
                    <h6>Contact</h6>
                    <p class="p-small">Tel : +21627301169</p>
                    <p class="p-small">Email  : <a href="mailto:ibtihelammouri@gmail.com"><strong>ibtihelammouri@gmail.com</strong></a></p>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <p class="p-small">Copyright © <a href="#your-link">QR Menu </a></p>
            </div> <!-- end of col -->
