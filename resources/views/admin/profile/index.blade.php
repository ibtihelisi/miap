  ...
  <body>
    <main class="main" id="top">
       ...
       @endif
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="/admin/profile/update/{{Auth::user()->id}}" >
                            @csrf                       
                    ...
                    <div class="card-body">
                      <form method="post" enctype="multipart/form-data" action="/admin/profile/updatePassword/{{Auth::user()->id}}" >
                          @csrf                       
