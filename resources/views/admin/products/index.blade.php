      ...
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            ...
            <div class="container">
              <h1 class="mt-3">liste Produit</h1>
              <hr>
                    ...
                    <table class="table table-bordered table-striped fs--1 mb-0">
                      <thead class="bg-200 text-900">
                        <tr>
                          ...
                          <th class="sort" data-sort="Nom Categorie">Nom Produit</th>
                          <th class="sort" data-sort="Decription Categorie">Decription Produit </th>
                          <th class="sort" data-sort="Price">Prix Produit </th>
                          <th class="sort" data-sort="Photo">Photo Produit </th>
                      ...
                      <tbody class="list">
                        ...
                        <tr>
                          ...
                          <td class="Nomn Categorie">{{ $p->name }}</td>
                          <td class="Description Categorie">{{ $p->description }}</td>
                          ...
                          <td class="Action">
                            <a  data-bs-toggle="modal" data-bs-target="#editCategory{{ $p->id }}" class="btn btn-success"> Modifier</a>

                            <a onclick="return confirm('voulez-vouz supprimer ce produit ? ') "
                                href="/product/delete/{{ $p->id }}" class="btn btn-danger">
                                Supprimer</a>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input name="name" class="form-control" id="exampleFormControlInput1"
                                type="text" placeholder=" tapper nom produit" required>
                        ...
                        <div class="mb-0">
                            <label class="form-label" for="exampleTextarea">Prix Produit</label>
                            <input name="price" class="form-control"  id="exampleFormControlInput1"
                            type="number" placeholder=" tapper  prix produit" required>
                        ...
                        <div class="mb-0">
                            <label class="form-label" for="exampleTextarea">Photo  Produit</label>
...
<!-- modal modifiier-->
@foreach ($products as $index=>$p )
       <div class="modal fade" id="editCategory{{$p->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="/categorie/update/{id}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input name="name"  value ="{{$p->name}}"  class="form-control" id="exampleFormControlInput1"
                        ...
                        <input type="hidden" value="{{ $p->id}}" name="idcategory" >
