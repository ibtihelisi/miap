      ...
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            ...
            <div class="container">
              <h1 class="mt-3" style="color: #272556">Edit FAQ Banner</h1>
              <hr>
          ...
          @csrf
              ...
              <div class="col-md-12">
                <div id="form-group-features" class="form-group  ">
                     <label class="col-form-label text-md-end" for="">Title</label>
            ...
            <div class="row py-2">
                ...
                <div class="col-md-6 text-end">
                  <a class="btn btn-outline-primary" class="mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Q and A</a>
                      ...
                      .btn.btn-outline-primary:active {
                        ...
                        color: #fff;
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-primary" type="submit " style="background-color: #f25c05" >Add</button>
